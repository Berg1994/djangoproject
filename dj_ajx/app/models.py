...
# 主要展示的商品
class MainShow(Main):
    categoryid = models.CharField(max_length=16)  # 种类ID
    brandname = models.CharField(max_length=100)  # 商品名
...
class FoodType(models.Model):
    typeid = models.CharField(max_length=16)  # 种类ID  如103532
    typename = models.CharField(max_length=100)  # 种类名称 对应优选水果
    childtypenames = models.CharField(max_length=200)  # 子分类下分类类名
